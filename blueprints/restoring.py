...
def deblur_temp():
    ...
    workflows = [
        {'title': '1) Image Acquisition and Preprocessing',
            'description': 'Start with the acquisition of the blurred image. Ensure the image is of the highest quality possible.Apply basic preprocessing steps like noise reduction, contrast enhancement, and resizing as necessary.'},
        ...
        {'title': '7) Evaluation:',
         'description': 'Assess the quality of the deblurred image using relevant metrics, such as PSNR (Peak Signal-to-Noise Ratio) and SSIM (Structural Similarity Index), or through visual inspection.'},
        ...
        {'title': '9) Validation and Iteration',
         'description': 'Verify the results and, if necessary, iterate through the process with adjustments to parameters or methods to achieve better deblurring.'},
...
def in_paint_temp():
    ...
    workflows = [
        ...
        {'title': '6. Inpainting Process',
         'description': 'Apply the selected inpainting algorithm to the image with the damaged regions, using the mask created earlier.'},
        ...
        {'title': '8. Evaluation',
         'description': 'Assess the quality of the inpainting results using appropriate evaluation metrics. Common metrics include structural similarity (SSIM), peak signal-to-noise ratio (PSNR), and human visual assessment.'},
        {'title': '9. Iterative Refinement (Optional)',
         'description': 'If the inpainting results are not satisfactory, consider iterative refinement using additional inpainting passes or fine-tuning of parameters.'},
...
def noise_reduction_temp():
    ...
    workflows = [
        ...
        {'title': '6) Implementation Tools',
         'description': 'You can implement Gaussian filtering using various tools and libraries, such as OpenCV, MATLAB, Python (with libraries like NumPy and SciPy), or dedicated image processing software. Choose the tool that best fits your project"s requirements and your familiarity with it.'},
