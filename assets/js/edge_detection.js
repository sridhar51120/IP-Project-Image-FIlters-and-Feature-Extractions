...
$(document).ready(function () {
    $('#dropdown-edge-detected-python-code').click(function () {
        ...
        let content = `
            <div class="container" id="edge-detected-python-code">
                    ...
                    <div class="mb-3"></div>
                    <div class="col col-12 d-flex justify-content-start"><span># Apply Canny edge detection</span>
                    </div>
                    <div class="col col-12 d-flex justify-content-start">
    ...
    $('#dropdown-edge-detected-matlab-script-code').click(function () {
        ...
        let content = `                <div class="container" id="edge-detected-matlab-code">
                    ...
                    <div class="mb-3"></div>
                    <div class="col col-12 d-flex justify-content-start"><span>% Apply Canny edge detection</span></div>
                    <div class="col col-12 d-flex justify-content-start">
