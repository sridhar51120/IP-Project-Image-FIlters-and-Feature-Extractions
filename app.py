...
from blueprints import enhancement, segmentation, restoring, modals, filters1, filters2, files, filters, videoModals
...
app.register_blueprint(videoModals.bp)
...
"""
TODO: Check the error's
# ConstraintLeastSquare(self):
# """